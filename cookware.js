...
smallimg7[2].onclick=function(){
    mainImage7.src=smallimg7[2].src;
}
smallimg7[3].onclick=function(){
    mainImage7.src=smallimg7[3].src;
}

smallimg7[4].onclick=function(){
    mainImage7.src=smallimg7[4].src;
}

smallimg7[5].onclick=function(){
    mainImage7.src=smallimg7[5].src;
}
...
smallimg9[2].onclick=function(){
    mainImage9.src=smallimg9[2].src;
}
...
// p-2
var mainImage15=document.getElementById("mainImage15");
var smallimg15=document.getElementsByClassName("small-img15");

smallimg15[0].onclick=function(){
    mainImage15.src=smallimg15[0].src;
}

smallimg15[1].onclick=function(){
    mainImage15.src=smallimg15[1].src;
}

smallimg15[2].onclick=function(){
    mainImage15.src=smallimg15[2].src;
}

// 9th row
// p-1
var mainImage16=document.getElementById("mainImage16");
var smallimg16=document.getElementsByClassName("small-img16");

smallimg16[0].onclick=function(){
    mainImage16.src=smallimg16[0].src;
}

smallimg16[1].onclick=function(){
    mainImage16.src=smallimg16[1].src;
}

smallimg16[2].onclick=function(){
    mainImage16.src=smallimg16[2].src;
}
